        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="rounded shadow bg-body-secondary text-center">
                    <a href="{{ route('table.index') }}" class="display-5 pb-2" style="text-decoration: none; color: black;">Articoli revisionati</a>
                </div>
            </div>



            <div class="col-md-9 shadow bg-body-secondary">
            @if($article_to_check)

        ...
        <div class="col-md-3">
            <aside class="aside bg-body-secondary " style="box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px;">
                <div class="col-md-3 w-100">
                    <div class="art-rev">
                        <a href="{{ route('revisor.index') }}" class="fs-4 pb-2" style="text-decoration: none; color: black;">{{__('ui.Dashboard')}} </a>
                    </div>

                    <div class=" art-rev">
                        <a href="{{ route('table.index') }}" class="fs-4 pb-2"
            ...
            <div class="bg-body-secondary rounded p-4" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px;">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 d-flex flex-column justify-content-end align-items-center gap-3">
                        <a href="{{ route('article.show', ['article' => $article_to_check->id]) }}" class="btn btn-info">Dettaglio</a>
